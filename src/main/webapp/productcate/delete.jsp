  ...
  <fieldset class='fieldset_basic'>
    <ul>
      <li class='li_none' style='font-weight: bold;'>
        삭제될 카테고리 그룹 이름: ${productcateVO.name }
      </li>
 <!--  
      <c:if test="${count_by_categrpno > 0 }">
        ...
        <li class='li_none' > 
         관련 글을 삭제해야 카테고리 그룹을 삭제 할 수 있습니다.<br>
         <span style='color: #FF0000;'>관련 글이 삭제되면 복구 할 수 없습니다.</span><br>
         관련 글을 삭제 하시겠습니까?
         <button type="button"  class="btn btn-info" onclick="delete_by_categrpno();">예(삭제진행)</button>
        </li>
      </c:if>
 -->          
      <li class='li_none' >
