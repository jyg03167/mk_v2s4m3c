...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' 
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-xs" name='mname' id='mname' 
                   value='${mkmemberVO.mname }' required="required" style='width: 30%;' placeholder="성명">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-xs" name='tel' id='tel' 
                   value='${mkmemberVO.tel }' required="required" style='width: 30%;' placeholder="전화번호"> 예) 010-0000-0000
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-xs" name='zipcode' id='zipcode' 
                   value='${mkmemberVO.zipcode }' required="required" style='width: 30%;' placeholder="우편번호">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-xs" name='address1' id='address1' 
                   value='${mkmemberVO.address1 }' required="required" style='width: 80%;' placeholder="주소">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-xs" name='address2' id='address2' 
                   value='${mkmemberVO.address2 }' required="required" style='width: 80%;' placeholder="상세 주소">
      </div>
    </div>   
