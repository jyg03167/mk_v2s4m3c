...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <ASIDE style='float: left;'>
      <A href='./member/list.do'>${memcateVO.name } 목록</A>  
  </ASIDE>
  ...
  <TR>
    ...
    <TD class='td'><A href="./read.do?memberno=${memberno}">${mkmemberVO.id}</A></TD>
    <TD class='td'><A href="./read.do?memberno=${memberno}">${mkmemberVO.mname}</A></TD>
    <TD class='td'>${mkmemberVO.tel}</TD>
    <TD class='td'>
      <c:choose>
    ...
    <TD class='td'>${mkmemberVO.mdate.substring(0, 10)}</TD> <!-- 년월일 -->
    <TD class='td'>
      ...
      <A href="./read.do?memberno=${memberno}&memcateno=${mkmemberVO.memcateno}"><IMG src='./images/update.png' title='수정'></A>
